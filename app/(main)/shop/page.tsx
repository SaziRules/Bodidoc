    ...
    <div className="w-full">
      ...
      <div className="relative w-full overflow-hidden">
        <div className="relative max-w-360 mx-auto px-6 md:px-10 lg:px-16 py-20 md:py-16">
          <h1
            className="font-display font-normal text-[#112942] dark:text-bd-dark leading-[1.05] mb-2"
            style={{ fontSize: "clamp(40px, 8vw, 42px)" }}
          >
            Shop All Products
          </h1>
          <p className="text-[14px] md:text-[14px] font-medium text-[#2f2f2f] dark:text-fg-body max-w-full leading-relaxed">
