  ...
  return (
    <ArticleShell>
      ...
      <div className="max-w-4xl mx-auto text-center mb-10 px-4">
        <h1 
          className="font-display font-medium text-[#112942] dark:text-bd-dark leading-6.75 mb-6"
      ...
      <div className="max-w-6xl mx-auto text-center mb-16 px-4">
        <p className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 px-4">
        <div className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25">
          <p className="mb-6 text-[#112942] dark:text-bd-dark font-bold text-lg">
          ...
          <ul className="list-disc pl-5 space-y-4 marker:text-[#112942] dark:marker:text-[#5b9ac8]">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 px-4">
        ...
        <div className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 order-1 md:order-2">
          <p className="mb-4 text-[#112942] dark:text-bd-dark font-bold text-lg">
