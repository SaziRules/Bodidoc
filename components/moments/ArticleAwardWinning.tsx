  ...
  return (
    <ArticleShell>
      ...
      <div className="max-w-4xl mx-auto text-center mb-10 px-4">
        <h1 
          className="font-display font-normal text-[#112942] dark:text-bd-dark leading-tight mb-6"
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12 px-4">
        <div className="text-[15px] text-center md:text-left font-normal text-[#333333] dark:text-fg-body leading-[1.6] space-y-6">
          <p>
      ...
      <div className="max-w-6xl mx-auto space-y-6 px-4 text-[15px] font-normal text-[#333333] dark:text-fg-body leading-[1.6] mb-16">
        <p>
        ...
        <p className="font-normal text-[#2f2f2f] dark:text-fg-body pt-1">
