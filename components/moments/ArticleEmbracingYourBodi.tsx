  ...
  return (
    <ArticleShell>
      ...
      <div className="max-w-7xl mx-auto text-center mb-10 px-4">
        <h1 className="font-display font-medium text-[#112942] dark:text-bd-dark leading-6.75 mb-6"
      ...
      <div className="max-w-5xl mx-auto text-center mb-16 px-4">
        <div className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 space-y-6">
          <p>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 px-4">
        <div className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 text-center md:text-left">
          <p>
      ...
      <div className="max-w-5xl mx-auto text-center mb-20 px-4">
        <p className="text-[15px] md:text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25">
        ...
        <p className="text-[15px] md:text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 pt-5">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 px-4">
        ...
        <div className="text-[15px] font-normal text-[#333333] dark:text-fg-body leading-5.25 text-center md:text-left order-1 md:order-2">
          <p>
      ...
      <div className="max-w-4xl mx-auto text-center pb-4 px-4">
        <p className="text-[15px] font-normal text-[#333333] dark:text-fg-body leading-5.25 mb-10">
