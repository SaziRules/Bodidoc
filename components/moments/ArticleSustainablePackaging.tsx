  ...
  return (
    <ArticleShell>
      ...
      <div className="max-w-3xl mx-auto text-center mb-12 px-4">
        <p className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 mb-6">
        ...
        <p className="text-[15px] font-bold text-[#112942] dark:text-bd-dark leading-5.25">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16 px-4">
        ...
        <div className="text-[15px] font-normal text-[#2f2f2f] dark:text-fg-body leading-5.25 text-center md:text-left order-1 md:order-2">
          <p>
      ...
      <div className="max-w-6xl mx-auto text-center space-y-6 px-4 pb-20">
        <p className="text-[15px] font-normal text-[#333333] dark:text-fg-body leading-[1.8]">
        ...
        <p className="text-lg font-bold text-[#112942] dark:text-bd-dark">
